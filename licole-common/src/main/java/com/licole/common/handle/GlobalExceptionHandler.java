...
import com.licole.common.pojo.CommonResult;
...
import static com.licole.common.exception.enums.GlobalErrorCodeConstants.*;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> allExceptionHandler(HttpServletRequest request, Throwable throwable) {
        if (throwable instanceof MissingServletRequestParameterException) {
            return missingServletRequestParameterExceptionHandler((MissingServletRequestParameterException) throwable);
        }
        if (throwable instanceof MethodArgumentTypeMismatchException) {
            return methodArgumentTypeMismatchExceptionHandler((MethodArgumentTypeMismatchException) throwable);
        }
        if (throwable instanceof MethodArgumentNotValidException) {
            return methodArgumentNotValidExceptionExceptionHandler((MethodArgumentNotValidException) throwable);
        }
        if (throwable instanceof BindException) {
            return bindExceptionHandler((BindException) throwable);
        }
        ...
        if (throwable instanceof NoHandlerFoundException) {
            return noHandlerFoundExceptionHandler((NoHandlerFoundException) throwable);
        }
        if (throwable instanceof HttpRequestMethodNotSupportedException) {
            return httpRequestMethodNotSupportedExceptionHandler((HttpRequestMethodNotSupportedException) throwable);
        }
